...
<section class="section section--catalog">
    <header class="section__header">
        ...
        <p class="section__lead">
            Vyberte si z aktuálně dostupných produktů. Objednávku dokončíte ve zlomku chvíle.
        </p>
        <p class="section__meta">
            <a class="button button--ghost" href="<?= htmlspecialchars($links->products(), ENT_QUOTES, 'UTF-8'); ?>">Zobrazit katalog</a>
