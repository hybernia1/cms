...
?>
  ...
  <div class="modal fade" id="mediaUploadModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <form class="modal-content" method="post" action="admin.php?r=media&a=upload" enctype="multipart/form-data" id="media-upload-form" data-ajax data-action="media_upload" data-reset-on-success="true">
